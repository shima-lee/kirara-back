...
const blogAtMeRouter = require('./routes/api/blog-at')
const squareRouter = require('./routes/api/blog-square')
...
app.use(blogAtMeRouter.routes(), blogAtMeRouter.allowedMethods())
